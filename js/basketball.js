...
function preload() {
    ...
    game.load.image('hoop', 'images/basketball/images/hoop.png');
    game.load.image('side rim', 'images/basketball/images/side_rim.png');
    game.load.image('front rim', 'images/basketball/images/front_rim.png');

    game.load.image('win0', 'images/basketball/images/win0.png');
    game.load.image('win1', 'images/basketball/images/win1.png');
    game.load.image('win2', 'images/basketball/images/win2.png');
    game.load.image('win3', 'images/basketball/images/win3.png');
    game.load.image('win4', 'images/basketball/images/win4.png');
    game.load.image('lose0', 'images/basketball/images/lose0.png');
    game.load.image('lose1', 'images/basketball/images/lose1.png');
    game.load.image('lose2', 'images/basketball/images/lose2.png');
    game.load.image('lose3', 'images/basketball/images/lose3.png');
    game.load.image('lose4', 'images/basketball/images/lose4.png');
